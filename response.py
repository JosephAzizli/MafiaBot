...
updater = Updater(token='5946373308:AAETYdqQP2iEUXdmjPuDQFYljn3FMLOKVTA') #TOKEN REDACTED
...
role_database['Vanilla'] = Role(name='Vanilla',
    alignment='Innocent',
    info = "Sən düz VƏTƏNDAŞSAN!\nHeç bir olayın yoxdu(Üzünə vurmaq kimi olmasın).\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
...
role_database['Cop'] = Role(name='Cop',
    alignment='Innocent',
    info = "Sən POLİSSƏN!\nGecə oyunçuların günahkar olub-olmadıqlarını görə bilərsən(Birbaşa rol görünmür).\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
...
role_database['Oracle'] = Role(name='Oracle',
    alignment='Innocent',
    info = "Sən KAHİNSƏN!\nGecə iki oyunçu hədəflə. Birinci oyunçunun günahsız olub-olmadığı ikinci oyunçuya aşkar olacaq. " \
    "Özünü hədəfləyə bilmərsən, ağıllı.\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 2,
    priority = 0,
...
role_database['Doctor'] = Role(name='Doctor',
    alignment='Innocent',
    info = "Sən HƏKİMSƏN!\nGecə digər oyunçuları sağalda bilərsən. "
    "Hər hansı bir hədəf bir neçə dəfə sağaldılsa peredoz gedib ölə bilər :)!\n"
    "Bütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
...
role_database['Roleblocker'] = Role(name='Roleblocker',
    alignment='Innocent',
    info = "Sən MƏŞUQƏSƏN!\n`Halal` yolla pul qazanırsan. Gecə digər oyunçuları bloklaya bilərsən.\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
    priority = 10,
...
role_database['Vigilante'] = Role(name='Vigilante',
    alignment='Innocent',
    info = "Sən QANUNSUZSAN!\nGecə hər hansı oyunçunu öldürə bilərsən(Vətəndaşların tərəfindəsən, unutma).\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
    priority = 5,
...
role_database['Bulletproof'] = Role(name='Bulletproof',
    alignment='Innocent',
    info = "Sən ŞANSLISAN!\nBir gecə səni öldürsələr həyatda qalma şansın var, unutma sadəcə bir dəfə.\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = False,
    has_day_action = False,
    number_of_targets = 0,
    priority = 5,
...
role_database['Horgie'] = Role(name='Horgie',
    alignment='Innocent',
    info = "Sən YAZIQSAN!\nGündüz gücünü aktivləşdirsən bot sənin günahsız olduğunu açıq şəkildə göstərəcək.\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = False,
    has_day_action = True,
    number_of_targets = 0,
    priority = 5,
...
role_database['Miller'] = Role(name='Miller',
    alignment='Innocent',
    info = "Sən DƏXLİSİZSƏN hahahah!\nGünahsız olsan da, araşdırıcı rollar səni Mafia olaraq görəcək. Bu nə yaşayışdı!\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = False,
    has_day_action = False,
    number_of_targets = 0,
    priority = 11,
...
role_database['Tracker'] = Role(name='Tracker',
    alignment='Innocent',
    info = "Sən İZSÜRƏNSƏN!\nGecə hər hansı bir oyunçunu izləyib kimə getdiyini görə bilərsən(Əgər gedibsə).\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
    priority = 0,
...
role_database['Watcher'] = Role(name='Watcher',
    alignment='Innocent',
    info = "Sən GÖZCÜSƏN!\nGecə hansısa oyunçunun pəncərəsindən baxıb kimin gəldiyini görə bilərsən (Əgər gəlibsə)).\nBütün mafialar ölsə qazanarsan(Çox gözləyərsən).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
    priority = 0,
...
role_database['Alien'] = Role(name='Alien',
    alignment='Alien',
    info = "Sən YADPLANETLİSƏN!\nGecə səni öldürsələr, sağ qala bilərsən, yalnız bir dəfə. Əgər sağ qalsan, aktivləşirsən.\nAktiv olduqdan sonra gündüz linç edilsən, qazanırsan(Dəxlisiz rollardan birisən, hətta ən dəxlisizi).",
    has_night_action = False,
    has_day_action = False,
    number_of_targets = 0,
    priority = 0,
...
role_database['Serial Killer'] = Role(name='Serial Killer',
    ...
    info = "SERİ QATİLSƏN!\nGecə hər hansı oyunçunu öldürə bilərsən. Həmçinin bir gecə ölsən, həyatda qalma şansın da var, amma tək gecəlik.\nQazanmaq üçün hər kəsi öldür.",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
    priority = 5,
...
role_database['Mafioso'] = Role(name='Vanilla',
    alignment='Mafia',
    info = "Sən MAFİASAN!\nDigər mafialarla gizli söhbət edə bilərsən. Gecə oyunçuları öldür.\n"
    "Bütün günahsızlar ölsə, qazanarsan(Çətin məsələdi).",
    has_night_action = False,
    has_day_action = False,
    number_of_targets = 0,
    priority = 0,
...
role_database['Godfather'] = Role(name='Godfather',
    alignment='Mafia',
    info = "Sən DONSAN (Godfather)!\nGecə oyunçuları öldür.\n"
    "Həmçinin, mafia olsan da, araşdırıcı rollar səni günahsız olaraq görəcək. Səni kələkbaz!\nBütün günahsızlar ölsə, qazanarsan(Çətin məsələdi).",
    has_night_action = False,
    has_day_action = False,
    number_of_targets = 0,
    priority = 11,
...
role_database['Mafia Doctor'] = Role(name='Doctor',
    alignment='Mafia',
    info = "Sən Mafia Həkimisən!\nDigər mafialarla gizli söhbət edə bilərsən. Gecə oyunçuları öldür.\n" \
    "Həmçinin, gecə digər oyunçuları sağalda bilərsən. "
    "Əgər, hədəf bir neçə dəfə sağaldılsa, peredoz gedib ölə bilər!\n"
    "Bütün günahsızlar ölsə, qazanarsan(Çətin məsələdi).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
...
role_database['Mafia Roleblocker'] = Role(name='Roleblocker',
    alignment='Mafia',
    info = "Sən Mafia Məşuqəsisən!\nİkiqat cəhənnəmlik. Digər mafialarla gizli söhbət edə bilərsən. Gecə oyunçuları öldür.\n" \
    "Həmçinin gecə hər hansı oyunçunu bloklaya bilərsən.\n"
    "Bütün günahsızlar ölsə, qazanarsan(Çətin məsələdi).",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
...
role_database['Mafia Rolecop'] = Role(name='Rolecop',
    alignment='Mafia',
    info = "Sən Mafia Detektivisən!\nDigər mafialarla gizli söhbət edə bilərsən. Gecə oyunçuları öldür.\n" \
    "Həmçinin, gecə hər hansı oyunçunun rolunu öyrənə bilərsən.\n"
    "Bütün günahsızlar ölsə, qazanarsan(Çətin məsələdi)",
    has_night_action = True,
    has_day_action = False,
    number_of_targets = 1,
...
role_database['Mafia Bulletproof'] = Role(name='Bulletproof',
    alignment='Mafia',
    info = "Sən Mafia Şanslısısan!\nGecə ölsən, sağ çıxma şansın var, sadəcə tək səfərlik.\nBütün günahsızlar ölsə, qazanarsan(Çətin məsələdi).",
    has_night_action = False,
    has_day_action = False,
    number_of_targets = 0,
    priority = 5,
...
def playerIsValid(bot,update,user_id, #Checks if player is allowed to input a command
    ...
    if not allow_off and phase == 'off':
        bot.sendMessage(chat_id=update.message.chat_id, text="Aktiv oyun yoxdur!",reply_to_message_id=update.message.message_id)
        return(False)
    elif not allow_startup and phase == 'startup':
        bot.sendMessage(chat_id=update.message.chat_id, text="Oyun hələ başlamayıb!",reply_to_message_id=update.message.message_id)
        return(False)
    elif not allow_nonplayer and not user_id in player_dict:
        bot.sendMessage(chat_id=update.message.chat_id, text="Sən oyunda deyilsən!",reply_to_message_id=update.message.message_id)
        return(False)
    elif only_host and not user_id == host_id:
        bot.sendMessage(chat_id=update.message.chat_id, text="Sadəcə oyun qurucu edə bilər!",reply_to_message_id=update.message.message_id)
        return(False)
    elif allow_dead == False and user_id in player_dict and player_dict[user_id].status == 'Dead':
        bot.sendMessage(chat_id=update.message.chat_id, text="Ölmüsən, qaqaş!",reply_to_message_id=update.message.message_id)
        return(False)
    elif only_private and not update.message.chat.type == 'private':
        bot.sendMessage(chat_id=update.message.chat_id, text="Bunu etmək üçün şəxsi çatda mənə yaz!",reply_to_message_id=update.message.message_id)
        return(False)
    elif not allow_day and phase == 'day':
        bot.sendMessage(chat_id=update.message.chat_id, text="Gündüz bunu edə bilmərsən!",reply_to_message_id=update.message.message_id)
        return(False)
    elif not allow_night and phase == 'night':
        bot.sendMessage(chat_id=update.message.chat_id, text="Gecə bunu edə bilmərsən!",reply_to_message_id=update.message.message_id)
        return(False)
    else:
        return(True)
...
def offerTargets(bot,update,command): ##Prompt the user to pick a target for /action. Provides a handy keyboard too
    ...
    bot.sendMessage(chat_id=update.message.chat_id, text="Oyunçu seç.", reply_markup=reply_markup,reply_to_message_id=update.message.message_id)
...
def sendNightMessage(bot,update):
    ...
    for player in player_dict.values():
            if player.status == 'Alive':
                string = "GECƏ " + str(day_count) + " çökür!\n"
                if player.role.has_night_action:
                    string += "Gecə üzərinə düşəni etmək üçün /action və ya /target komandalarını istifadə et, pas keçmək üçün /pass.\n"
                if player.role.sends_mafia_kill:
                    string += "Öldürmək üçün /kill , pas keçmək üçün /pass. Digər mafialarla müzakirə apardığından əmin ol.\n"
                elif not player.role.has_night_action:
                    string += "Sənin gecə edə biləcək heç nəyin yoxdur, ona görə də yıxıl yat və mafiaların qətliam törətməsini gözlə."
...
def sendDayMessage(bot,update):
    ...
    for player in player_dict.values():
            if player.status == 'Alive':
                string = "Gün " + str(day_count) + "Günəş şəfəqlərini sifətimizə vurur!\n"
                if player.role.has_day_action:
                    string += "Gündüz üzərinə düşəni etmək üçün /action və ya /target komandalarından istifadə et.\n"
                string += "Hər hansı oyunçunu linç etmək(asdırmaq) üçün /vote və ya /lynch komandalarından istifadə et.\nƏgər heç kimi linç etmək istəmirsənsə, /abstain komandasını istifadə et.\nSəsini dəyişmək üçün /retract komandasını istifadə et."
                bot.sendMessage(chat_id=player.chat_id, text=string)

def sendDeathMessage(bot,victim):
    ##Send personal message too
    message = "Allah rəhmət eləsin!\n"
    bonus_string = choice(["Ah be dostum. Amma hələ də ətrafda ruh kimi dolana bilərsən!",
                            "Çox təəssüf. Amma oyunun necə irəlilədiyinə baxa bilərsən!",
                            "Arada belə bədbəxtliklər olur, hə?",
                            "Ümid edirəm ki, pis hiss etmirsən, hehe!",
                            "Lap yaxşı. Yenə də əyləncəlidir, düzdür?"])
...
def checkIfNightFinished(bot,update):
    ...
    for player in player_dict.values():
        ...
        if not test_mode:
            ...
            bot.sendMessage(chat_id=group_id, text="Gecə etdiyiniz həmlələr göndərilir, ancaq hələ TEST MODE -dadır, "
            "gecə mərhələsi əllə dəyişdirilməlidir.")
...
def resolveNightActions(bot,update):
        ...
        if role.name == 'Cop':
            if len(player.targets) > 0:
                if not 'blocked' in player.effects:
                    ...
                    string = "Sən " + target.name + " araşdırdın və onun " + result + " olduğunu öyrəndin."
                    if result == 'Innocent':
                        bonus_string = choice(["","","",
                        "\n(Phew! Rahatladıcı hissdir, hə?)",
                        "\n(Oyunun məzmunu budur dostum, öldür ya da öl. Hahaha!)"])
                    elif result == 'Mafia':
                        bonus_string = choice(["","","",
                        "\n(Ack! Pis adamlardan biri idi!)",
                        "\n(Oh boy! Now that's not a very nice thing to be, is it!)"])
                    else:
                        bonus_string = choice(["\n(Huh? Y-you're not telling me it's...!)",
                        "\n(Düşündüyümü düşünürsən...?)",
                        "\n(Nəə!? Amma... bu nə deməkdir!?)"])
                    string += bonus_string
                    bot.sendMessage(chat_id=player.chat_id, text=string)
                else:
                    bot.sendMessage(chat_id=player.chat_id, text="Araşdırmandan bir nəticə çıxmadı, bacarıqsız.")

        if role.name == 'Rolecop':
            if len(player.targets) > 0:
                if not 'blocked' in player.effects:
                    target = player.targets[0]
                    string = "Sən " + target.name + " araşdırdın və onun " + target.role.name + " olduğunu öyrəndin."
                    bot.sendMessage(chat_id=player.chat_id, text=string)
                else:
                    bot.sendMessage(chat_id=player.chat_id, text="Araşdırmandan bir nəticə çıxmadı, bacarıqsız.")
        ...
        if role.name == 'Oracle':
            if len(player.targets) == 2:
                if not 'blocked' in player.effects:
                    ...
                    string = "Keçən gecə " + dream.name + " haqda qəribə yuxu gördün " + result + "."
            ...
            if len(player.targets) > 0:
                ...
                if not 'blocked' in player.effects:
                    if len(target.targets) == 0 and (mafia_kill[0] == False or not mafia_kill[2] == target):
                        string = "Sən " + target.name + " izini sürdün, amma o, keçən gecə heç kimi ziyarət etməyib."
                    else:
                        string = "Sən " + target.name + " izini sürdün və onun hədəflədiyi insanları gördün:\n"
                    ...
                    bot.sendMessage(chat_id=player.chat_id, text="İzləməndən heç bir nəticə çıxmadı.")
            ...
            if len(player.targets) > 0:
                ...
                if not 'blocked' in player.effects:
                    ...
                    if len(visitor_list) == 0:
                        string = "Sən " + target.name + " pəncərəsindən baxdın, amma gecə heç kəs onu ziyarət etməyib."
                    else:
                        shuffle(visitor_list)
                        string = "Sən " + target.name + " pəncərəsindən baxdın və ona qonaq gələnləri gördün:\n"
                        for visitor in visitor_list:
                            string += visitor.name + "\n"
                    bot.sendMessage(chat_id=player.chat_id, text=string)
                else:
                    bot.sendMessage(chat_id=player.chat_id, text="Gözcülüyün heç bir nəticə vermədi.")
    ...
    for player in resolution_list:
        ...
        if player.alignment == 'Alien' and 'dying' in player.effects and not 'activated' in player.effects:
            ...
            bonus_string = choice(["Kimsə səni öldürməyə çalışdı... amma bu sənin son formun deyil! Sən indi Alien (Yadplanetli) olaraq aktivləşdin!",
                        "Heh heh heh... Axmaqlar... Kimsə səni öldürməyə çalışdı, amma bu səni daha da gücləndirdi - indi aktivsən.",
                        "Kimsə səni öldürməyə çalışdı - amma bu sənin əsl gücünü ortaya çıxardı! İndi aktivsən!"])
        ...
        if 'healed' in player.effects:
            ...
            while ('bulletproof' in player.effects) and ('dying' in player.effects):
                ...
                player.effects.remove('dying')
                bonus_string = choice(["Kimsə sənə hücum etdi və şansını itirdin.",
                "Görünür ki, düşmənlərin var. Artıq o qədər də şanslı sayılmazsan!",
                "Kimsə səni öldürməyə çalışdı! Amma bəxtin gətirdi və ölmədin. Gələn dəfə bu qədər şanslı olmayacaqsan."])
                bot.sendMessage(chat_id=player.chat_id, text=bonus_string)
    ...
    #Begin the day phase
    day_count += 1
    string = "İndi Gündüzdür" + str(day_count) + ".\n"
    if len(deaths) == 0:
        string += "Təəccüblüdür ki, heç kəs ölmədi.\n"
    else:
        for victim in deaths:
            string += victim.name + " Öldü. O " + victim.flip() +" idi.\n"
    ...
    bonus_string = ''
    if len(deaths) > 1:
        bonus_string = choice(["(Wow, nə qədər ölü var.)",
            "(Bu gün toplu cinayət olub.)",
            "(Əsl qətliam!)"])
        string += bonus_string
    ...
    if not checkWinConditions(bot,update):
        ...
        bot.sendMessage(chat_id=group_id, text="İndi gecə olanları müzakirə edin və linç üçün səs verin.")
        if day_count == 1:
            with open('PW-AA OST- 13 - Search - Opening 2001.mp3', 'rb') as song:
                bot.send_audio(chat_id=group_id, audio=song,duration = 108,title = "Gün " + str(day_count))
...
def checkWinConditions(bot,update):
    ...
    or alien_win): #Alien win
        if alien_win:
            ...
            string = "Yadplanetli hamınızı oyuna gətirdi! " + alien_name.upper() + " QAZANDI!\n\n"
        elif number_of_players == 0:
            string = "Hamı öldü! BOT QAZANDI!\n\n"
        elif number_of_players == number_of_aliens:
            string = "Yadplanetli bacarıqsız çıxdı və qalan hamı öldü! BOT QAZANDI!\n\n"
            ...
            for player in player_dict.values():
                if player.status == 'Alive' and player.alignment == 'Serial Killer':
                    name = player.name
                    break
            string = "Seri Qatil hamının axırına çıxdı!\n" + name.upper() + " QAZANDI!\n\n"
        elif number_of_mafiosi == 0 and number_of_serial_killers == 0:
            string = "Bütün şübhəlilər asıldı və ya öldü! XALQ QAZANDI!\n\n"
        elif number_of_mafiosi == number_of_players:
            string = "Şəhər camaatı bir-bir öldürüldü! MAFIA QAZANDI!\n\n"
        ...
        string += "\nOynadığınız üçün təşəkkürlər!"
        bot.sendMessage(chat_id=group_id, text=string)

        ##Send personal messages too
        for player in player_dict.values():
            string = "Oyun bitdi. Oynadığınız üçün təşəkkürlər, " + player.name + "!"
            bot.sendMessage(chat_id=player.chat_id, text=string)
        clearGame()
        return(True)
    else:
...
def help_command(bot,update): #Help
    helptext = "Mafia botunda istifadə edə biləcəyiniz komandalar.\n" \
    "\nOYUN QURMA KOMANDALARI:\n" \
    "/start: Qarşılama mesajı göndərir və son yeniləmələri göstərir.\n" \
    "/create: Yeni oyun yaradır.\n" \
    "/join: Oyuna qoşulur.\n" \
    "/playerlist: Oyundakı oyunçuların siyahısını göstərir.\n" \
    "/add: Oyuna rollar əlavə edir. Sadəcə /add yaz və əlavə oluna biləcək rolları gör.\n" \
    "/rolelist: Oyunda olacaq rolları gör.\n" \
    "/randomize [x] [y] [z]: Create a random setup with [x] players, [y] of whom are mafia, where one in [z] roles are power roles.\n" \
    "/resetroles: Oyun strukturunu resetlə.\n" \
    "/ready: Oyuna başlamaq üçün istifadə olunur (hamı qoşulduqdan sonra istifadə edin). Sadəcə oyun qurucu istifadə edə bilər. \n" \
    "\nOYUNÇU KOMANDALARI:\n" \
    "/role: Rolun haqda məlumat verir.\n" \
    "/lynch və ya /vote [name]: Kimisə linç etmək üçün səs ver (gündüz boyu).\n" \
    "/abstain: Heç kimə səs vermə.\n" \
    "/retract: Səsini geri al.\n" \
    "/votelist: Hər oyunçunun nə qədər səsi olduğunu gör.\n" \
    "/action və ya /target [name]: Rolunu istifadə et(əgər bacarırsansa).\n" \
    "/kill [name]: Gecə birini öldür. Sadəcə mafia istifadə edə bilər və hər gecə sadəcə biri.\n" \
    "/undo: Öldürmə seçimini geri al.\n" \
    "/pass: Gecəni pas keç.\n" \
    "\nOYUN QURUCU KOMANDALARI:\n" \
    "/advance: Gecəni gündüz, gündüzü gecəyə keçir. " \
    "(Qeyd: gecə bütün rollar üstünə düşəni etsə, avtomatik olaraq gündüzə keçiləcək.)\n" \
    "/remind: Fəaliyyətini təsdiq etməmiş bütün oyunçulara xatırladıcı göndər.\n" \
    "/abort: Hazırki oyunu ləğv et."
...
def start(bot,update): #Start message
    bot.sendMessage(chat_id=update.message.chat_id, text="Salam! mən 601.21 özəl botuyam. "
    "Yeni oyun yaratmaq üçün qrupa /create yaz. "
    "İstifadə edilə biləcək bütün komandaları görmək üçün /help yaz. Botda səhvlik görsəniz, Yusifə deyin :)!\n\n")
...
def create(bot, update): #Creates a new game
    ...
    global test_mode
    if not phase == 'off':
        bot.sendMessage(chat_id=update.message.chat_id, text="Hal-hazırda aktiv oyun var.",reply_to_message_id=update.message.message_id)
    elif update.message.chat.type == 'private' or update.message.chat.type == 'channel':
        bot.sendMessage(chat_id=update.message.chat_id, text="Yeni oyun yaratmaq üçün /create yaz. İlk öncə məni qrupa əlavə et!",
        ...
        phase = 'startup'
        bot.sendMessage(chat_id=group_id, text="Yeni oyun " + host_name + " tərəfindən yaradıldı!\n"
        "Qoşulmaq üçün /join yazın.\n"
        "Kimlərin qoşulduğunu görmək üçün /playerlist yazın.\n\n" +
        host_name + ", oyunda olacaq rolları seçmək üçün /add istifadə et.\nHazırki oyunda olacaq rolları görmək üçün isə /rolelist yaz, siyahını təmizləmək üçün isə /resetroles .\n"
        "Təsadüfi rollarla oyun qurmaq üçün /randomize yaz.\n\n" +
        host_name + " hamı qoşulduqdan sonra /ready yazmağı unutma.")
        if test_mode:
...
def join(bot, update): #Lets a player join during startup
    ...
    global group_id
    if phase == 'off':
        bot.sendMessage(chat_id=update.message.chat_id, text="Qoşulacaq oyun yoxdur.",reply_to_message_id=update.message.message_id)
    elif update.message.from_user.id in player_dict:
        bot.sendMessage(chat_id=update.message.chat_id, text="Artıq oyundasan.",reply_to_message_id=update.message.message_id)
    elif not phase == 'startup':
        bot.sendMessage(chat_id=update.message.chat_id, text="Təəssüf ki, oyun artıq başlayıb. Sonrakı oyuna qoşularsan!",
        reply_to_message_id=update.message.message_id)
    elif not update.message.chat.type == 'private':
        bot.sendMessage(chat_id=update.message.chat_id, text=" /join üçün bota şəxsi çatda yaz.",
        reply_to_message_id=update.message.message_id)
    else:
        ##Add the player
        ...
        string = name + " oyuna qoşuldu!\n"
        bonus_string = choice(["Gözünüz bunun üstündə olsun.",
                        "Buna da diqqət edin " + name + "!",
                        "Bunu tanımıram.",])
        if new_user.id in friend_dict:
            if friend_dict[new_user.id] == 'MD':
                bonus_string = choice(["I am duty-bound to describe him as 'handsome'.",
                        "Nə yaxşı qoşuldun, zəhmət çəkməzdin."])
